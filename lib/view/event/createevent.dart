...
class SellBookMain extends StatelessWidget {
  ...
  final GlobalKey addressedropkey = GlobalKey();
        ...
        child: Column(children: [
          ...
          Row(
            children: [
              ...
              SizedBox(
                width: width - 110,
                child: GetBuilder<Sellcontroller>(builder: (_) {
                  return MultiSelectDropDown.network(
                    ...
                    responseParser: (response) {
                      ...
                      final list = (result as List<dynamic>).map((e) {
                        ...
                        return ValueItem(
                          label:
                              ' latitude = ${item['lat']} longitude = ${item['long']}', //id = ${item["id"]}
                          value: item['id'].toString(),
                        );
                      }).toList();
